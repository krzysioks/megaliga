...
<div class="<?php echo hestia_layout(); ?>">
                        ...
                        <div class="row">
                            ...
                            if ($_POST['submitDraftLotteryOrderDraw']) {
                                ...
                                if (!$getUserData[0]->is_draw_round1_draft_order) {
                                    ...
                                    echo '  <div class="marginBottom10 marginLeft1em">';
                                    ...
                                    echo '  </div>';
                                    echo '  <div class="marginBottom40  marginLeft1em">';
                            ...
                            function drawDraftForm($draftWindowState, $userId)
                            {
                                ...
                                if (is_user_logged_in() && $draftWindowState[0]->draft_window_open && count($getGroupName)) {
                                    ...
                                    if ($getDraftTurnUserId[0]->ID == $userId) {
                                        ...
                                        echo '          <span class="left scoreTableName marginRight5 marginBottom5">Draft do zespołu:</span><span class="teamOverviewContent marginBottom5 draft">' . $getUserData[0]->name . '</span>';
                                        echo '      </div>';
                                        echo '      <div class="displayFlex flexDirectionRow">';
    ...
    <script type="text/javascript">
        (function() {
            ...
            title.innerHTML = 'draft - ' + title.innerHTML;
        })();
    </script>
    <?php get_footer(); ?>